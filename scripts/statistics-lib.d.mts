import type { StatisticsContentPost, StatisticsContentTotals, StatisticsData } from '../src/types/statistics'
...
export function mergeAnalyticsRows(rows?: unknown[]): Map<string, {
  activeUsers: number
