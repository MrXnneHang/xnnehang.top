...
1. **在 `src/content/memos/` 下新建一个 `.md` 文件**，不要碰其他任何文件
2. **原封不动**把用户说的话写进文件正文，不要加工、不要解释、不要改格式、不要包装
3. 文件名用 `YYYY-MM-DD-NN.md` 格式（如 `2026-06-23-01.md`），frontmatter 只写 `date: "YYYY-MM-DD"`
4. 新增一条记录即可，不要理解内容含义

示例已有文件：`src/content/memos/2026-06-22-01.md`、`src/content/memos/2026-06-22-02.md`
...
- 用户说"把这段话加到碎碎念" = 只在 `src/content/memos/` 下新建 .md 文件，不做其他任何事
