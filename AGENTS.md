...
- **Submodule image workflow** — move requested images into `src/assets/img/`, commit and push the image submodule first, then commit the parent repository’s submodule pointer. → [details](./gotcha.md#submodule-image-commit-order)
